...
// Shown in place of a page that has no module editor: the log consoles under
// a domain (/infra/logs, /comms/mailroom) are tools rather than layouts. The
// Sections tab works everywhere, so this points there instead of leaving a
// blank page. Every domain route itself edits in place since Phase 6.
      ...
      <section className="editor editor--note" aria-labelledby="editor-unavailable-heading">
        ...
        <p className="editor__lede">
          {drillDown
            ...
            : `${view.label} has no module layout to customize.`}{" "}
