...
export const DEFAULT_WIDGETS: WidgetConfig[] = [
  ...
  { id: "raw-metrics", title: "Live metrics", category: "house", size: "lg", order: 23, selfFetch: true },
  { id: "home-control", title: "Office", category: "house", size: "md", order: 24, selfFetch: true },
